...
<div class="col-md-12">
	...
	<tr>
		...
		<td><?php echo h($product['Product']['product_type']); ?>&nbsp;</td>
		<td><?php echo $this->Html->image('../files/product/photo/' . $product['Product']['photo_dir'] . '/' . 'thumb_' .$product['Product']['photo'], array('url' => array('controller' => 'products', 'action' => 'view', $product['Product']['id']))); ?></td>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Eliminar'), array('action' => 'delete', $product['Product']['id']), array('confirm' => __('Está seguro que desea eliminar el producto con código %s?', $product['Product']['code']))); ?>
		</td>
